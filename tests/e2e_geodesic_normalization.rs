...
fn oracle_violation_tag(v: &OracleViolation) -> String {
    match v {
        ...
        OracleViolation::RegionLeak(_) => "RegionLeak".into(),
        ...
        OracleViolation::CancelCorrectness(_) => "CancelCorrectness".into(),
        OracleViolation::CancelDebt(_) => "CancelDebt".into(),
        OracleViolation::CancelOrdering(_) => "CancelOrdering".into(),
        OracleViolation::RuntimeEpoch(_) => "RuntimeEpoch".into(),
        OracleViolation::ChannelAtomicity(_) => "ChannelAtomicity".into(),
        OracleViolation::WakerDedup(_) => "WakerDedup".into(),
